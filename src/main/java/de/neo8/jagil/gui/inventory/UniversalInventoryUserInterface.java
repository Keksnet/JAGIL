...
import de.neo8.jagil.gui.UniversalUserInterface;
...
public interface UniversalInventoryUserInterface extends UniversalUserInterface, InventoryHolder {
    ...
    /**
     * Closes the {@link Inventory} of this {@link InventoryUserInterface} save.
     * If the player's opened inventory is not the one returned by {@link #getInventory()} it should not be closed.
     *
     * @throws IllegalStateException thrown if the inventory was not opened
     */
    void closePlayerInventory() throws IllegalStateException;
